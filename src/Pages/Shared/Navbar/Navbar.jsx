    ...
    <div className="bg-[#FFF4E4]">
      <div className="navbar lg:max-w-[85%] mx-auto">
        <div className="navbar-start">
          ...
          <NavLink className="font-bold lg:text-3xl text-2xl" to={"/"}>
            ArtisanAlley
          </NavLink>
        </div>
          ...
          {user && (reload || user.photoURL) ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="btn btn-neutral text-white text-lg hidden lg:flex"
              >
                Logout
              </button>
            </div>
            ...
            <>
              <Link
                to={"/login"}
                className="hidden md:flex btn bg-transparent border-[#CD3520] text-[#CD3520] hover:bg-[#CD3520] hover:text-white text-base"
              >
                Sign In
              </Link>
